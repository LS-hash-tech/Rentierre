/*
 ...
 Source Server         : 39.101.138.246
 Source Server Type    : MySQL
 Source Server Version : 50730
 Source Host           : 39.101.138.246:3306
 Source Schema         : rentierre

 Target Server Type    : MySQL
 Target Server Version : 50730
 File Encoding         : 65001

 Date: 20/09/2024 15:51:35
*/
...
CREATE TABLE `Category`  (
  ...
  `category_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'Category',
  `parent_cate_id` bigint(20) NULL DEFAULT NULL COMMENT 'Parent ID',
  `status` int(20) NOT NULL COMMENT 'Status',
  `del_flat` int(10) NULL DEFAULT NULL,
...
CREATE TABLE `Product`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `cate_id` bigint(20) NOT NULL COMMENT 'Category ID',
  `product_name` varchar(1023) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'Product Name',
  `price` decimal(10, 2) NOT NULL COMMENT 'Price',
  `image` varchar(2047) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'Image',
  `owner_id` bigint(20) NOT NULL COMMENT 'Owner ID',
  `size` int(10) NULL DEFAULT NULL COMMENT 'Size',
  `color` int(10) NULL DEFAULT NULL COMMENT 'Color',
  `gener` int(10) NULL DEFAULT NULL COMMENT 'Gener',
  `description` varchar(2047) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'Description',
...
CREATE TABLE `Review`  (
  ...
  `user_id` bigint(20) NULL DEFAULT NULL COMMENT 'ReviewerID',
  `title` varchar(1023) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'Title',
  `body` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT 'Content',
  `rating` decimal(10, 2) NULL DEFAULT NULL COMMENT 'Rating',
...
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '代码生成业务表字段' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 238 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;
